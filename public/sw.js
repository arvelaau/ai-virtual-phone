...
// Web Push delivery — see PROACTIVE-MESSAGE-2.0-PLAN.md. This fires even when
// no page/tab from this app is open, which is the whole point: it does not
// depend on any client-side JS timer staying alive (the thing that breaks on
// iOS once the PWA is backgrounded/evicted).

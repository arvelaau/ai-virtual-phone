...
export function MomentsCompose({ onClose, onPublished }: Props) {
    ...
    const getCharName = (charId: string) => chars.find(c => c.id === charId)?.name ?? "Unknown";
        ...
        <div className="modal-overlay" data-ui="modal" role="presentation" onClick={onClose}>
            ...
            >
                <div className="compose-modal-header">
                    <button onClick={onClose} className="compose-header-icon" aria-label="Cancel">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                            <line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" />
                        </svg>
                    </button>
                    <span className="compose-modal-title">Post to Moments</span>
                    <button onClick={handlePublish} disabled={!canPublish} className="compose-header-icon compose-header-send" aria-label="Post">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="compose-top-area">
                    ...
                    {!photoPreview && (
                        <input
                            ...
                            placeholder="Text-only post, no image needed"
                ...
                <div className="compose-nav-list">
                    ...
                    <div className="compose-nav-row" onClick={() => { setShowLocation(!showLocation); if (!showLocation) setLocationDraft(location); }}>
                        <div className="compose-nav-left">
                            ...
                            <span className="compose-nav-label">Location</span>
                        </div>
                    ...
                    {showLocation && (
                        <div className="compose-panel-inline" style={{ display: "flex", alignItems: "center", gap: 8, padding: "8px 16px" }}>
                            ...
                            />
                            <button className="compose-inline-btn" onClick={handleConfirmLocation}>Confirm</button>
                        </div>
                    )}
                    ...
                    <div className="compose-nav-row" onClick={() => setShowMention(!showMention)}>
                        <div className="compose-nav-left">
                            ...
                            <span className="compose-nav-label">Notify Who Can See</span>
                        </div>
                        <div className="compose-nav-right">
                    ...
                    <div className="compose-nav-row" onClick={() => setShowVisibility(!showVisibility)} style={{ borderBottom: showVisibility ? "0.5px solid var(--c-card-border)" : "none" }}>
                        <div className="compose-nav-left">
                            ...
                            <span className="compose-nav-label">Who Can See This</span>
                        </div>
                        <div className="compose-nav-right">
                            <span className="compose-nav-value">{visibleCount === enrichedContacts.length ? "Public" : `Visible to Some (${visibleCount})`}</span>

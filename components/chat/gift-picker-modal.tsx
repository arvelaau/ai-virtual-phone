                ...
                <div className="px-4 pt-4 pb-3 flex items-center justify-between gap-3">
                    <div className="flex items-center gap-2 min-w-0">
                        ...
                        <div className="min-w-0">
                            <div className="ts-16 font-semibold">Send Gift</div>
                            <div className="ts-11 text-[var(--c-icon)] truncate">From delivered shopping orders</div>
                        </div>
                    </div>
                    <button
                        type="button"
                ...
                <div className="p-4 flex flex-col gap-3 overflow-hidden">
                    {isGroup && (
                        <div className="flex flex-col gap-2">
                            <div className="ts-12 text-[var(--c-icon)]">To</div>
                    ...
                    <div className="overflow-y-auto hide-scrollbar flex flex-col gap-2 pr-0.5" style={{ maxHeight: "330px" }}>
                        {filteredGifts.length === 0 ? (
                            <div className="rounded-2xl bg-[var(--c-input)]/70 px-4 py-8 text-center">
                                ...
                                <div className="ts-13 font-medium">No gifts to send</div>
                                <div className="ts-12 text-[var(--c-icon)] mt-1 leading-5">
                                    Items will appear here once your shopping orders are delivered.
                                </div>
                            </div>
                                ...
                                >
                                    ...
                                    <div className="min-w-0 flex-1">
                                        ...
                                        <div className="ts-12 mt-2 flex items-center justify-between gap-2">
                                            ...
                                            <span className="text-[var(--c-icon)] truncate">{gift.deliveredTimeLabel || "Delivered"}</span>
                                        </div>
                                    </div>
                                </button>
                            );

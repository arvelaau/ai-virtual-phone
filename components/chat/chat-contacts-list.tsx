    ...
    return (
        <div className="relative flex-1 h-full">
                ...
                rightAction={
                    <button
                        ...
                        onClick={() => {
                            ...
                            setIsSendingAdd(false);
                            setGreetingText(identity?.name ? `I'm ${identity.name}` : "Hi there");
                        }}
                    >
            ...
            <div className="px-5">
                    ...
                    <div className="mb-3">
                        <div className="minimal-list-item" onClick={onSelectMascot}>
                            ...
                            <div className="flex-1 overflow-hidden h-[48px] flex flex-col justify-center gap-1">
                                <div className="ts-16 font-medium text-[var(--c-text-title)] truncate">{mascotSettings.nickname || "AI Assistant"}</div>
                                <div className="ts-13 text-[var(--c-text)] opacity-80 truncate font-normal">Built-in Creative Assistant</div>
                            </div>
                        </div>
                    </div>
                )}
                ...
                {contacts.length === 0 ? (
                    <div className="ui-empty">
                        <span className="menu-desc">No contacts yet — tap the icon in the top right of Chats to add one</span>
                    </div>
                ) : (
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 overflow-hidden h-[48px] flex flex-col justify-center gap-1">
                                                ...
                                                <div className="ts-13 text-[var(--c-text)] opacity-80 truncate font-normal">
                                                    {latestPost[char.id] || "No moments yet"}
                                                </div>
                                            </div>
                                        </div>
                                    );
            ...
            {isAddFriendOpen && (
                ...
                <PageShell title="Add Friend" onBack={() => { setIsAddFriendOpen(false); if (addFromCardRef.current) { addFromCardRef.current = false; onPendingAddContactBack?.(); } }}>
                                ...
                                {addQuery.trim().length > 0 && (
                                    ...
                                    >
                                        ...
                                        <div className="menu-label-group">
                                            <span className="menu-label">Search: <span className="text-[var(--c-success)]">{addQuery}</span></span>
                                        </div>
                                    </button>
                                )}
                            </div>
                            {!mascotSettings.chatEnabled && (
                                <div className="menu-group" style={{ marginTop: 12 }}>
                                    <div className="menu-item" style={{ pointerEvents: "none" }}>
                                        <span className="menu-desc">Available built-in assistant</span>
                                    </div>
                                    <button
                                        className="menu-item"
                                        onClick={() => {
                                    ...
                                    >
                                        ...
                                        <div className="menu-label-group" style={{ minWidth: 0 }}>
                                            ...
                                            <span className="menu-desc">Won&apos;t send an automatic greeting after re-adding</span>
                                        </div>
                                    </button>
                                </div>
                            )}
                    ...
                    {addResult === null && (
                        <div className="ui-empty"><span className="menu-desc">This user doesn&apos;t exist</span></div>
                    )}
                            ...
                            <div className="menu-group">
                                <div className="menu-item !items-start">
                                    ...
                                    <div className="menu-label-group">
                                        ...
                                        <div className="menu-desc">WeChat ID: {addResult.wechatID || "N/A"}</div>
                                        <div className="menu-desc">Bio: {addResult.persona ? addResult.persona.slice(0, 30) + (addResult.persona.length > 30 ? "..." : "") : "None"}</div>
                                    </div>
                                </div>
                            </div>
                            <button onClick={() => setIsSendingAdd(true)} className="ui-btn ui-btn-success w-full">Add to Contacts</button>
                        </div>
                    )}
                    {isSendingAdd && addResult && (
                        <div className="page-menu">
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                >Send</button>
                                <button onClick={() => setIsSendingAdd(false)} className="ui-btn ui-btn-ghost w-full">Cancel</button>
                            </div>
                        </div>
                    )}
                </PageShell>

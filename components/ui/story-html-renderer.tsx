...
function HtmlPageSegment({ html, onOptionSelect, htmlPageMode }: HtmlPageProps) {
    ...
    const srcDoc = useMemo(() => {
        ...
        //
        // Two guards against a RATCHETING measurement, which showed up as a large blank gap
        // under the card (ported from upstream 7929e87):
        //  - documentElement.scrollHeight is deliberately NOT part of the max. The parent sets
        //    the iframe height from what we report, and the root element's scrollHeight then
        //    reflects that height rather than the content — so once it grows it never shrinks,
        //    and each measurement locks in the previous one.

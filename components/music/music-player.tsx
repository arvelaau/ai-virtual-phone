...
export default function MusicPlayer() {
    ...
    const togglePlayerStyle = useCallback(() => {
        setPlayerStyle(prev => {
            ...
            showMusicToast(next === "vinyl" ? "Switched to vinyl style" : "Switched to modern cover style");
            return next;
        });
    }, [showMusicToast]);
        ...
        <div className="music-player mp-lumen" style={ambientVars}>
            ...
            <div className="mp-top">
                ...
                <div className="mp-top-actions">
                    ...
                    <button className="music-player-ctrl-btn mp-top-btn" onClick={openMiniChat} title="Chat mini-window">
                        <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
                            <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
                        </svg>
                    </button>
                    <button className="music-player-ctrl-btn mp-top-btn" onClick={openShareViaChat} title="Share to chat">
                ...
                {view === "lyrics" ? (
                    <div className="mp-lyrics-wrap" onClick={() => setView("cover")}>
                        {hasLyrics ? (
                            ...
                            <div className="mp-lyrics mp-lyrics-empty">
                                <div className="mp-lyric-line" data-active="">No lyrics yet</div>
                            </div>
                        )}
                    </div>
                ) : playerStyle === "vinyl" ? (
                    ...
                    <div className="mp-cover-area" onClick={() => setView("lyrics")}>
                        ...
                        <div className="mp-lyric-peek">
                            {activeLyricText ? (
                                <>&ldquo;{activeLyricText}&rdquo;<span>Tap to view lyrics</span></>
                            ) : hasLyrics ? (
